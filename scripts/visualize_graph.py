...
if __name__ == "__main__":
    pkl_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "datas", "graph.pkl")
    html_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "graph_view.html")
