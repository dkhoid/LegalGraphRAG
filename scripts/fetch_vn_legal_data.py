...
Output: datas/law_to_dispute.json, raw_data/law_corpus.jsonl
"""
...
def main():
    ...
    # Backup old data
    backup_dir = os.path.join(PROJECT_ROOT, "raw_data_backup_cn")
    ...
    for entry in law_to_dispute_entries:
        disputes = entry["items"][0]["crime"] if entry["items"] else []
